# This python code is used to process disaster messeges and categories data
import sys
import pandas as pd
import numpy as np
import sqlite3
...
def load_data(messages_filepath, categories_filepath):
    ...
    """
    Loads two givens datasets and merges them
...
def clean_data(df):
    """
    Function used to clean the merged df
...
def save_data(df, database_filename):
    """
    Function is used to save processed df to a SQLite database.
...
def main():
    """
    This is main function for data processing and it calls all of the above functions.
    It takes dataset and database path as a run time arguments.
    """
    if len(sys.argv) == 4:
        ...
        print('Given Dataset is cleaned and saved to database!')
